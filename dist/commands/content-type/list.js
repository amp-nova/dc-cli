...
exports.desc = "List Content Type's";
exports.builder = {
    ...sorting_options_1.SortingOptions,
    ...data_presenter_1.RenderingOptions
};
exports.itemMapFn = ({ id, settings, contentTypeUri }) => {
...
exports.handler = async (argv) => {
    ...
    const contentTypeList = await paginator_1.default(hub.related.contentTypes.list, sorting_options_1.extractSortable(argv));
    new data_presenter_1.default(contentTypeList.map(value => value.toJSON())).render({
        json: argv.json,
