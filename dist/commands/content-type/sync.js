...
exports.desc = 'Sync Content Type with the schema';
...
exports.handler = async (argv) => {
    ...
    const contentType = await client.contentTypes.get(argv.id);
    const contentTypeCachedSchema = await contentType.related.contentTypeSchema.update();
    new data_presenter_1.default(contentTypeCachedSchema.toJSON()).render({
        json: argv.json,
